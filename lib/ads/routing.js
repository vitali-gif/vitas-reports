...
export const GOOGLE_PROJECT_SOURCES = {
  ...
  // כרגע פעיל בו קמפיין אחד, "Shami | Kalisher | Sokolov | HaZoarim"; הכלל
  // מתאים לפי "shami" כדי שגם קמפיינים עתידיים באותו חשבון ייכנסו.
  'כלל הפרויקטים': [
    { customer: '2713605466', agency: 'VITAS', any: ['shami', 'שמי'] },
  ],
}
