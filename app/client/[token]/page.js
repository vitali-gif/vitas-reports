  ...
  const renderCrmResponseDashboard = useCallback(() => {
    ...
    return (
      <>
        ...
        {dowHasData && (
          <div className="section">
            <div className="section-title"><div className="section-icon" style={{background:'var(--gradient-3)' || 'var(--gradient-2)'}}>📅</div>פילוח לפי יום בשבוע <InfoTip text="כמה לידים נכנסו בכל יום בשבוע, ומתוכם כמה בסופו של דבר המירו לפגישה (גם אם הפגישה נקבעה בימים אחרים).\n\nהמדידה היא לפי יום כניסת הליד, לא לפי יום קביעת הפגישה. שימושי לזיהוי באיזה יום בא הקהל הכי איכותי." /></div>
