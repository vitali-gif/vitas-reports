    ...
    return (
      <>
        ...
        <div className="chart-grid" style={{gridTemplateColumns: '1fr 1fr'}}>
          ...
          <div className="section">
            <div className="section-title"><div className="section-icon" style={{background:'var(--gradient-3)' || 'var(--gradient-2)'}}>📡</div>הכי איטיים — לפי מקור <InfoTip text="המקורות מסודרים מהאיטי ביותר למהיר ביותר. עוזר לזהות איזה מקור לידים מקבל טיפול לקוי" /></div>
            <div className="chart-card" style={{padding:'10px'}}>
              <table className="data-table">
